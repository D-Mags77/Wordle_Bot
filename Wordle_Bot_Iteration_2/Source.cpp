...
int main() {
	...
	for (int i = 0; i < 100000; i++) {
		...
		//string CorrectWord = "would"; //which is not doing it right it is not getting rid of the c in the first position
		...
		int PLACEHOLDER = 1;
		while (PLACEHOLDER != 0) {
			//NextGuess = WordListVectorCOPY[0];
			NextGuess = WordListVectorCOPY[rand() % WordListVectorCOPY.size()]; //this is where the data has to come in
