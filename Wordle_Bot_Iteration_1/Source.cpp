...
int main() {
	...
	for (int i = 0; i < 10; i++) {
		...
		while (win != 1) {
			string NextGuess = WordListVectorCOPY[0];
			//cout << "This is the next word the bot is guessing " << NextGuess << endl;
			totalguesses++;
			if (NextGuess == CorrectWord) {
				win = 1;
				break;
			}
			else {
				WordListVectorCOPY.erase(WordListVectorCOPY.begin());
			}
		}


		//cout << "The correct word is " << CorrectWord << endl;
		//cout << "This is the total Number of Guesses " << totalguesses << endl;;
	...
	cout << "The average score of the Wordle Bot that just goes through the list and does nothing else of 1000 games is" << endl;
	cout << average;
	cout << endl;
